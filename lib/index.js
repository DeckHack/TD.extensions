 ...
 */
function add(extension, enable, init) {
 ...
 */
function enable(extensionName, init) {
 ...
 */
function checkDependencies(extensionName) {
	let extension = this.getExtension(extensionName);
 ...
 */
function checkConflicts(extensionName) {
	let extension = this.getExtension(extensionName);
 ...
 */
function isEnabled(extensionName) {
 ...
 */
function initializeExtension(extensionName) {
	let extension = this.getExtension(extensionName);
 ...
 */
function destroyExtension(extensionName) {
	let extension = this.getExtension(extensionName);
 ...
 */
function reorderEnabledExtensions(enabledExtensions) {
	let extensionOrder = this.resolveDependencyGraph();
